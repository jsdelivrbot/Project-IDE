...
exports.format = {
    ...
    foreignCurrency: function (test) {
        ...
        var tests = [
                [1000.234,'â¬','$0,0.00','â¬1,000.23'],
                [1001,'â¬','$ 0,0.[00]','â¬ 1,001'],
                [1000.234,'â¬','+$0,0.00','+â¬1,000.23'],
                [1000.234,'â¬','$+0,0.00','â¬+1,000.23'],
                [1000.234,'â¬','0,0.00 $','1,000.23 â¬'],
                [-1000.234,'â¬','($0,0)','(â¬1,000)'],
                [-1000.234,'â¬','(0,0$)','(1,000â¬)'],
                [-1000.234,'â¬','$0.00','-â¬1000.23'],
                [-1000.234,'â¬','+$0,0.00','-â¬1,000.23'],
                [1230974,'â¬','($0.00 a)','â¬1.23 m'],
                [1000.234,'â¬','+$0a','+â¬1k'],
                ...
                // small numbers - see issue #145
                [-0.00000000000001,'â¬','$0,0','â¬0'],
                [-0.00000000000001,'â¬','$0,0.00','â¬0.00']
            ],
            i;
